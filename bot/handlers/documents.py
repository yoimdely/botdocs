...
async def wizard_back(callback: CallbackQuery, state: FSMContext, storage: StorageService, analytics: AnalyticsService) -> None:
    await callback.answer()
    await go_back(callback.message, state, storage, analytics)
